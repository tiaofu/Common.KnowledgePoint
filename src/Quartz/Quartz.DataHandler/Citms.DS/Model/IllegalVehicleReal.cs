...
namespace Citms.PIS.Model.Punish
{
    ///<summary>
    ///违法记录表
    ///</summary>
    ...
    public class IllegalVehicleReal
    {
        ...
        ///违法时间
        ///</summary>
        [Column("OCCURTIME", TypeName = "DATE")]
    ...
    public class VehiclePassing
    {
        ...
        ///是否被篡改 
        ///</summary>     
        public bool? Falsified { get; set; }

        ///<summary>
        ///超速比值（如超速20%，则为20） 
        ///</summary> 	    
        public double? SpeedOver { get; set; }
        ...
        ///点位X坐标 
        ///</summary> 	    
        public double? SpottingX { get; set; }

        ///<summary>
        ///点位Y坐标 
        ///</summary> 	    
        public double? SpottingY { get; set; }
        ...
        /// <summary>
        /// 二次识别前结果，如果取到二次识别对应结果则把数据库取出的数据赋给该值
        /// </summary>
        public VehiclePassing PreRecognition { get; set; }        
        ...
        /// 设备功能类型
        /// </summary>
        public string AssetsFunType { get; set; }
    }
    /// <summary>
    /// 违法审核步骤枚举
    /// </summary>
